 ...
 !function(a, b) {
    ...
    var c = {
        ...
        createWidgetType: function(b, d, e) {
            ...
            return g.types = g.types.concat([b]),
            a.extend(g, d),
            g.constructor = f,
    ...
    c.Widget = function(b) {
        var d = this
          ...
          , j = function() {
            ...
            a.forEach(function(a) {
                ...
                e.hide.onOutsideContextMenu && a[0].addEventListener("contextmenu", p, !0),
          ...
          , k = function(b, c) {
            ...
            if (a.isFunction(d))
                ...
                if (!f[d])
                    throw "Reference Error: The effect " + d + " not found";
                f[d].apply(f, c)
            }
        }
          , l = function() {
          ...
          , m = function(a) {
            if (a.my) {
                var b = /left|right/
                  ...
                  , f = a.my.split(" ")
                  , h = [];
                1 === f.length && (b.test(f[0]) ? f.push("center") : f.unshift("center")),
          ...
          , n = function(b) {
            if (!t(b)) {
                if (e.hide.onClick) {
                    if (a(b.target).closest(e.selectors.preventClose).length)
                        return
                } else if (b.target !== this)
                    return;
                d.hide()
            }
        }
          ...
          , q = function() {
            ...
            e.closeButton && d.addElement("closeButton", '<div><i class="' + e.closeButtonClass + '"></i></div>');
          ...
          , s = function() {
            a.each(e, function(a) {
                ...
                b && (b = b[1].charAt(0).toLowerCase() + b[1].slice(1),
                d.on(b, this))
            })
        }
          , t = function(a) {
          ...
          , w = function() {
            ...
            a.forEach(function(a) {
                ...
                e.hide.onOutsideClick && a[0].removeEventListener("click", p, !0),
                e.hide.onOutsideContextMenu && a[0].removeEventListener("contextmenu", p, !0),
        ...
        this.hide = function() {
            if (d.isVisible())
                ...
                k("hide", arguments),
                w(),
                e.preventScroll && d.getElements("body").removeClass(e.classes.preventScroll),
                d.trigger("hide"),
                d
        }
        ,
        this.init = function(a, b) {
            if (!(a instanceof c.Instance))
                throw "The " + d.widgetName + " must to be initialized from an instance of DialogsManager.Instance";
            return l(),
            d.trigger("init", b),
            r(a, b),
            q(),
        ...
        this.setID = function(a) {
            return g.widget.attr("id", a),
            d
        }
        ,
        this.setHeaderMessage = function(a) {
            return d.getElements("header").html(a),
            d
        }
        ,
        this.setMessage = function(a) {
            return g.message.html(a),
            d
        }
        ,
        this.setSettings = function(b, c) {
            return jQuery.isPlainObject(c) ? a.extend(!0, e[b], c) : e[b] = c,
            d
        }
        ,
        this.show = function() {
            ...
            j(),
            e.preventScroll && d.getElements("body").addClass(e.classes.preventScroll),
            d.trigger("show"),
            d
        }
        ,
        ...
        activeKeyDown: function(a) {
            if (this.focusedButton) {
                ...
                if (a.which === b) {
                    ...
                    a.shiftKey ? (c = d - 1,
                    c < 0 && (c = this.buttons.length - 1)) : (c = d + 1,
